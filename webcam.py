...
if __name__ == "__main__":
    with pyvirtualcam.Camera(width=CAM_PROPS["WIDTH"], height=CAM_PROPS["HEIGHT"], fps=CAM_PROPS["FPS"]) as cam:
        ...
        gui.create_parameter_slider(5, CAP_PROPS, "GAUSSIAN_KERNEL_SIZE", "Gaussian kernel size", values=(0,30,1))
        gui.create_parameter_slider(6, CAP_PROPS, "GAUSSIAN_KERNEL_SIGMA", "Gaussian kernel sigma", values=(0,10,1))
